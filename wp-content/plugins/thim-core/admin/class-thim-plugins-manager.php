...
class Thim_Plugins_Manager {
	 ...
	 * @var bool
	 */
	public static $is_writable = null;

	/**
	 * Return unique instance of Thim_Plugins_Manager.
	 *
	 * @since 0.4.0
	 */
	...
	public function enqueue_scripts( $page_now ) {
		...
		wp_enqueue_script( 'thim-plugins-manager', THIM_CORE_ADMIN_URI . '/assets/js/plugins/plugins-manager.js', array( 'thim-isotope' ) );
	...
	private function localize_script() {
		wp_localize_script( 'thim-plugins-manager', 'thim_plugins_manager', array(
