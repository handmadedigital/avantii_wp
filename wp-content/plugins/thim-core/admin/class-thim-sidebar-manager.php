...
class Thim_Sidebar_Manager {
	...
	/**
	 * Return unique instance of Thim_Metabox.
	 *
	 * @since 0.1.0
	 */
	...
	public function handle_action() {
		...
		$new_sidebar_name = ! empty( $_POST['thim_input_sidebar_name'] ) ? $_POST['thim_input_sidebar_name'] : false;

		if ( $new_sidebar_name ) {
			return self::create_new_sidebar( $new_sidebar_name );
		}

		$delete_sidebar_id = ! empty( $_POST['thim_input_remove_sidebar'] ) ? $_POST['thim_input_remove_sidebar'] : false;
		if ( $delete_sidebar_id ) {
			return self::delete_sidebar( $delete_sidebar_id );
		}
	...
	public function admin_page_sidebar() {
		...
		<div class="thim-manager-sidebar">
			...
			<form method="POST">
				<h3><?php esc_html_e( 'Create new sidebar', 'thim-core' ); ?></h3>
				<label for="thim_input_sidebar_name"><?php esc_html_e( '', 'thim-core' ); ?></label>
