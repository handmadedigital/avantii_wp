...
class Thim_Custom_WC_Widget_Cart extends WC_Widget_Cart {
	...
	function form( $instance ) {
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id( 'hide_cart_number' )); ?>"><?php esc_html_e( 'Hide cart number', 'hairsalon' ); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id( 'hide_if_empty' )); ?>"><?php esc_html_e( 'Hide if cart is empty', 'hairsalon' ); ?></label>
		</p>
		<?php
	}
}