...
if ( ! function_exists( 'thim_woocommerce_catalog_ordering' ) ) {
	function thim_woocommerce_catalog_ordering() {
		...
		$catalog_orderby_options = apply_filters( 'woocommerce_catalog_orderby', array(
			'menu_order' => esc_html__( 'Default', 'hairsalon' ),
			'popularity' => esc_html__( 'Popularity', 'hairsalon' ),
			'rating'     => esc_html__( 'Rating', 'hairsalon' ),
			'date'       => esc_html__( 'Newness', 'hairsalon' ),
			'price'      => esc_html__( 'Price', 'hairsalon' ),
		) );
