        ...
        array(
            ...
            'fields' => array(
                ...
                array(
                    ...
                    'label'       => esc_html__( 'Blog Layouts', 'hairsalon' ),
                    'tooltip'     => esc_html__( 'Choose a layout to display for archive post.', 'hairsalon' ),
                    'default'     => 'masonry_layout',
                    'priority'    => 5,
                    'multiple'    => 0,
                    'choices'     => array(
                        'masonry_layout' => esc_html__( 'Masonry', 'hairsalon' ),
                        'grid_layout'    => esc_html__( 'Grid', 'hairsalon' ),
                    ),
                ),
                //Blog Columns
                array(
