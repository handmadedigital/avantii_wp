...
thim_customizer()->add_section(
    array(
        'id'       => 'copyright',
        'title'    => esc_html__( 'Copyright', 'hairsalon' ),
        'panel'    => 'footer',
        'priority' => 50,
    )
);
...
thim_customizer()->add_field(
    array(
        'type'     => 'switch',
        'id'       => 'copyright_bar',
        'label'    => esc_html__( 'Show Copyright Text', 'hairsalon' ),
        'tooltip'  => esc_html__( 'Turn on to display the copyright bar.', 'hairsalon' ),
        'section'  => 'copyright',
        'default'  => false,
        'priority' => 10,
        'choices'  => array(
...
thim_customizer()->add_field(
    array(
        ...
        'tooltip'     => esc_html__( 'Allows you to choose background color for your copyright area. ', 'hairsalon' ),
        'section'     => 'copyright',
        'default'     => '#946a94',
        'priority'    => 15,
        'alpha'       => true,
...
thim_customizer()->add_field(
    array(
        'type'            => 'textarea',
        'id'              => 'copyright_text',
        'label'           => esc_html__( 'Copyright Text', 'hairsalon' ),
        'tooltip'         => esc_html__( 'Enter the text that displays in the copyright bar. HTML markup can be used.', 'hairsalon' ),
        'section'         => 'copyright',
